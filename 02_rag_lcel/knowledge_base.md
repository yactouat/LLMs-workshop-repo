...
## 2. Ticketing
* **Regular Rate:** **49€** (Includes lunch and coffee for the day).
* **Reduced Rate:** **19€** (Reserved for students, job seekers, and those with low income; includes lunch and coffee).

## 3. Schedule & Speakers
The conference features a mix of conferences, short workshops, and keynotes covering topics such as Web, Cloud & DevOps, Mobile, IoT, Languages, Security, Big Data & AI, and UX/UI.
...
* **Availability:** Pickup only on November 27 at the event (no delivery).
...
* **Mentorship Program:** Senior developers are paired with junior team members for career guidance.
* **Certification Support:** Full reimbursement for industry-recognized certifications (AWS, GCP, Azure, etc.).

### 8.3 Vacation and Time Off
* **Annual Leave:** 30 days of paid vacation per year (in addition to French public holidays).
* **Sick Leave:** Unlimited sick days with doctor's note after the 3rd consecutive day.
* **Parental Leave:** 16 weeks fully paid parental leave for all parents (birth or adoption).
* **Mental Health Days:** 3 additional wellness days per year, no questions asked.
* **Sabbatical:** After 5 years of service, employees can take a 3-month paid sabbatical.
...
* **Swag:** Volunteers receive a special edition t-shirt and conference swag bag.
* **References:** Professional references provided upon request for volunteers who contribute 20+ hours.
